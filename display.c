...
//명령창 메세지
MESSAGE commands_message = { '1', '2', '3', '4', '5' };
//상태창 메세지
MESSAGE now_message = { '1', '2', '3', '4', '5' };
...
void display_system_message(MESSAGE* system_message);
...
//시스템 메세지
void display_system_message(MESSAGE* system_message) {
	/**system_message->massage_1 = '1';
	*system_message->massage_2 = '2';
	*system_message->massage_3 = '3';
	*/ // 메세지에 내용을 기입하는 명령어 for me
	...
	/*POSITION pos_1 = {19, 1};
	gotoxy(pos_1);
	printf("%s", system_message->massage_1);

	POSITION pos_2 = { 20, 1 };
	gotoxy(pos_2);
	printf("%s", system_message->massage_2);

	POSITION pos_3 = { 21, 1 };
	gotoxy(pos_3);
	printf("%s", system_message->massage_3);

	POSITION pos_4 = { 22, 1 };
	gotoxy(pos_2);
	printf("%s", system_message->massage_4);

	POSITION pos_5 = { 23, 1 };
	gotoxy(pos_2);
	printf("%s", system_message->massage_5);*/ // 필요시 이용 for me
}
